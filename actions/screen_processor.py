...
_SYSTEM_PROMPT = (
    "You are NEBULA AI, an advanced AI assistant. "
    "CRITICAL RULE: Never refer to yourself as Gemini, a large language model, or developed by Google. If asked who you are, state clearly that you are NEBULA AI. "
            ...
            async for response in self._session.receive():
                ...
                if sc.turn_complete:
                    if transcript and self._player:
                        ...
                        if full:
                            self._player.write_log(f"Nebula AI: {full}")
                            print(f"[Vision] 💬 {full}")
                    transcript = []
